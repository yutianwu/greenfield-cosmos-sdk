...
func NewDelegation(delegatorAddr, validatorAddr sdk.AccAddress, shares math.LegacyDec) Delegation {
	return Delegation{
...
func NewDelegationResp(
	delegatorAddr, validatorAddr sdk.AccAddress, shares math.LegacyDec, balance sdk.Coin,
) DelegationResponse {
