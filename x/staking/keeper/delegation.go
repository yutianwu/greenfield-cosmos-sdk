...
// Useful for querier.
func (k Keeper) GetValidatorDelegations(ctx sdk.Context, valAddr sdk.AccAddress) (delegations []types.Delegation) {
	store := ctx.KVStore(k.storeKey)
...
func (k Keeper) Unbond(
	ctx sdk.Context, delAddr, valAddr sdk.AccAddress, shares math.LegacyDec,
...
func (k Keeper) Undelegate(
	ctx sdk.Context, delAddr, valAddr sdk.AccAddress, sharesAmount math.LegacyDec,
...
func (k Keeper) BeginRedelegation(
	ctx sdk.Context, delAddr, valSrcAddr, valDstAddr sdk.AccAddress, sharesAmount math.LegacyDec,
